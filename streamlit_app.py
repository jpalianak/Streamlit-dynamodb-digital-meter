...
if show_cnn:
    fig.add_scatter(
        ...
        mode='lines+markers',
        line=dict(color='blue', shape='linear'),  # Color azul para CNN
...
if show_opencv:
    fig.add_scatter(
        x=df_orig_opencv['Date'] + pd.Timedelta(seconds=1),
        y=df_orig_opencv['Value']*10,
        mode='lines+markers',
        line=dict(color='red', shape='linear'),  # Color rojo para OpenCV
