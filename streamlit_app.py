...
st.header(r"$\tiny  \color{black} \textbf{Sistema de monitoreo en tiempo real del consumo de corriente realizado a traves de procesamiento de imagenes del amperimetro}$")
st.write('')
